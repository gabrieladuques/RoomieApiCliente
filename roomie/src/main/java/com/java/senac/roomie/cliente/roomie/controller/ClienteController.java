package br.com.java.senac.roomie.cliente.roomie.controller;
...
public class ClienteController {
    ...
    public ResponseEntity<Cliente> atualizar(@RequestParam String clienteData, @RequestParam(value = "file", required = false) final MultipartFile file ) throws IOException {
        final var ClienteRequest = mapper.readValue(clienteData, ClienteRequest.class);

        if (file != null){
            ClienteRequest.setFoto(file.getInputStream().readAllBytes());
        }
